 ...
 */
public class LoseFinalPointsEveryMilitary implements SupportFunctionsDecorator {
    ...
    public int extraLostOfPoints(PlayerHandler playerHandler) {
        int numberOfMilitaryPoints = playerHandler.getScore().getMilitaryPoints();
        return numberOfMilitaryPoints;
    }
}
